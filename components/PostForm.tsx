      ...
      await fetch('/api/sheets', {
        ...
        body: JSON.stringify({
          ...
          post: {
            ...
            likes: String(stats.likes ?? ''), comments: String(stats.comments ?? ''), shares: String(stats.shares ?? ''), reach: String(stats.reach ?? ''), nonFollowerPct: String(stats.nonFollowerPct ?? ''),
            aiGenerated: String(initialData?.aiGenerated ?? false),
