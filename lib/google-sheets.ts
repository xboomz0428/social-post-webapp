...
export async function ensureSheetsExist(config: SheetConfig) {
  ...
  const requiredSheets = [
    { title: '貼文', headers: ['ID', '帳號ID', '帳號名稱', '標題', '內容', '平台', '公式', 'Day', '狀態', '排程時間', '發佈時間', '讚', '留言', '分享', '觸及', '非追蹤者%', 'AI生成', 'AI提供者', '備註', '建立時間', '更新時間'] },
    { title: '帳號', headers: ['ID', '平台', '帳號名稱', '顯示名稱', '每週篇數', '每天上限', '偏好時段', '啟用', '建立時間'] },
